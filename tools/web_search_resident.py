"""
Tool pour recherche web avec Tavily + reranking LLM (RESIDENT)
Optimisé pour residents au Togo
"""
...
@tool
def web_search_tool_resident(query: str) -> dict:
    """
    Recherche web RESIDENT - Optimisé pour citoyens VIVANT AU TOGO.
    Recherche via Tavily avec focus prioritaire sur domaines .gouv.tg officiels.
    
    ✅ Pour: Citoyens résidant AU TOGO
    📍 Focus: service-public.gouv.tg, gouv.tg
    🔍 Requête: Doit être reformulée en 2-4 mots-clés (ex: "carte nationale biométrique Togo")
    
    Args:
        query: La requête de recherche reformulée (2-4 mots-clés)
